...
/**
 */
public class HdrHistogramDruidModule implements DruidModule
{
  @Override
  public List<? extends Module> getJacksonModules()
  {
    return ImmutableList.of(
        new SimpleModule().registerSubtypes(
            HdrHistogramFoldingAggregatorFactory.class,
            HdrHistogramAggregatorFactory.class,
  ...
  {
    if (ComplexMetrics.getSerdeForType("hdrHistogram") == null) {
      ComplexMetrics.registerSerde("hdrHistogram", new HdrHistogramFoldingSerde());
    }
  }
}
